...
function draw() {
  ...
  if (ebullet.isTouching (army1)){
    army1.visible = false;
    num = 1
  }

  if (ebullet.isTouching (army3)){
    army3.visible = false;
    num = 1
  }

  if (ebullet.isTouching (army)){
    army.visible = false;
    num = 1
  }

  if (ebullet.isTouching (soldier)){
    soldier.visible = false;
    num = 1
  }

  if (ebullet.isTouching (tank)){
    tank.visible = false;
    num = 1
  }

  if (ebullet.isTouching (tank2)){
    tank2.visible = false;
    num = 1
  }

  if (ebullet.isTouching (missileLauncher1)){
    missileLauncher1.visible = false;
    num = 1
  }

  if (ebullet.isTouching (aagni)){
    aagni.visible = false;
    num = 1
  }
